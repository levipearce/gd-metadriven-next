...
export default (props) => (
  <App pathname={props.url.pathname} >
      ...
      <DashboardFilterHeader props={props} title="Sales" filter1={{title:'Filter1Title', displayValue:'BrandName', keyValue:'1'}} filter2={{title:'Filter1Title'}} filter3={{title:'Filter1Title'}}/>
      <ContentBox>
